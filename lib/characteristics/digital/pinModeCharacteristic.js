...
function PinModeCharacteristic(bleno, arduinoManager) {
    this.bleno = bleno;
    this.Descriptor = this.bleno.Descriptor;
    this.Characteristic = this.bleno.Characteristic;
...
PinModeCharacteristic.prototype.onWriteRequest = function(data, offset, withoutResponse, callback) {
    if (offset) {
        ...
        var pin = (data.readUInt8(0) & 0xf0) >> 4;
